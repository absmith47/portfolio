...
hyper_dist_title <- "With 112 Conservative MPs in the ballot, the most likely outcome would be drawing five Conservative MPs."
hyper_dist_subtitle <- "Hypergeometric distribution with 20 balls drawn from an urn of 458 balls. There were 95 Conservative MPs entered into the Private Members' Bill ballot, drawn on Thursday 05 September 2024."
hyper_dist_caption <- "Source: Hypergeometric distribution for values between 0 and 20. Total balls are equal to 458, with 112 Blue balls and a sample size of 20."
